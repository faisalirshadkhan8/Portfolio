...
const HeroSection = () => {
  ...
  return (
        <div 
          id="hero"
          ref={heroRef}
          className={`min-h-screen lg:h-screen relative overflow-x-hidden md:overflow-hidden transition-all duration-300 bg-gradient-to-br from-black via-gray-900 to-black`}
        >
      {/* Advanced Background Effects */}
  <div className="inset-0 z-0 absolute md:fixed">
  ...
  <div className="relative z-10 pt-20 pb-20 md:pb-12 px-6 lg:px-8">
